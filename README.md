...
### 📊 [Click Here to View the Interactive Dashboard][(Screenshot 2026-05-21 151843.png](https://github.com/Hitesh-2146/tata-motors-supply-chain-dashboard/blob/3d348745b243c25e5b73979c3f2854eb5e8feff9/Screenshot%202026-05-21%20151843.png) =YOUR_POWER_BI_PUBLIC_LINK_HERE)
...
1. Don't forget to replace `YOUR_POWER_BI_PUBLIC_LINK_HERE` with your live sharing link.
2. Replace `YOUR_GITHUB_USERNAME` and `YOUR_REPOSITORY_NAME` in the image path line so your screenshot loads perfectly on the front page of your repository!
